...
function AppointmentForm() {
  ...
  const onSubmit = async (data) => {
    ...
    axios
      .post('appointments/store', { ...data, appointment_id })
      .then((response) => {
        ...
        Email.send({
            ...
            <body style="background-color: #f2f2f2;">
              <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
                <div style="background-color: #fff; border-radius: 4px; padding: 20px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
                  ...
                  <p style="font-size: 16px; margin-bottom: 20px; color: #333;">These are the details of your appointment confirmed schedule:</p>
                  ...
                  <p style="font-size: 16px; margin-bottom: 20px; color: #333;">Please present it to the receptionist in order to assist you.</p>
                  ...
                  <p style="font-size: 16px; margin-bottom: 20px; color: #333;">Phone: 09659051766<br />Email:contactusclinic@gmail.com</p>
                  <div style="text-align: center;">
                  <a href="https://clinicmp2.netlify.app/" style="display: inline-block; background-color: #333; color: #fff; padding: 10px 20px; border-radius: 4px; text-decoration: none; font-size: 16px; margin-top: 20px;">Visit our website</a>
                  </div>
                  </div>
                  </div>
                    </body>
          ...
          `,
            ...
            message => {
              toast.success("Appointment has been scheduled successfully! Please check your email");
              reset();
              setIsLoading(false);
            }
          );
    ...
    <section className="px-4 md:px-0 md:py-20 mt-[85px] bg-[#EDFDF2] font-sora grid grid-cols-1 md:grid-cols-2 gap-4">
      <div>
        <form onSubmit={handleSubmit(onSubmit)} className="grid gap-4">
          <h2 className="text-center font-bold text-3xl md:text-4xl mb-4 col-span-2">
      ...
      <div className='grid place-items-center px-6'>
        <p>Note:  Please check your spam folder if you don't receive an email after filling up the form. If you don't receive an email, please email us at <a href="mailto:contactusclinic@gmail.com" className='text-blue-500 underline'>contactusclinic@gmail.com</a>. Thank you!
        </p>
      </div>
